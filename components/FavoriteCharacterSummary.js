...
export default function FavoriteCharacterSummary({
    character,
    index,
    scrollY,
}) {
    const favoriteCharacter = useSelector(
        (state) =>
            state.favoriteCharacters.value.filter(
                    ...
                    <View style={Styles.info}>
                        <View style={Styles.row}>
                            <Text
                                style={{
                                    ...Styles.status,
                                    backgroundColor: status[character.status],
                                }}
                            />
                            ...
                            >
                                <Image
                                    style={Styles.icon}
                                    source={require('../assets/favoritesCharacter.png')}
                                />
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={Styles.row}>
                            ...
                            <TouchableOpacity
                                style={Styles.iconWrap}
                                onPress={() => handlePressCommentInput()}
                            >
                                <Image
